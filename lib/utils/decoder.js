module.exports = {
  //Yea, I wrote this. Sup.

  //petitioners and respondents use the same decoder: partiesDecoder
  //peitionerState and respondentsState use the same decoder: stateDecoder
  caseSourceDecoder: {
